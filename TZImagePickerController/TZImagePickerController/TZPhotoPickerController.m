...
- (void)viewDidLoad {
    ...
    if (tzImagePickerVc.navLeftBarButtonSettingBlock) {
        ...
        if (tzImagePickerVc.customShowAlbumCategory) {
            ...
            [self.albumTitleView setImage:[UIImage tz_imageNamedFromMyBundle:@"btn_tz_album_trangle1"] forState:UIControlStateNormal];
            [self.albumTitleView setImage:[UIImage tz_imageNamedFromMyBundle:@"btn_tz_album_trangle2"] forState:UIControlStateSelected];
